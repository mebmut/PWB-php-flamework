 ...
 */
class Model {
  protected $_model, $_validates=true,$_validationErrors=[];
  public $id;
  protected static $_db, $_table, $_softDelete=false;

  public function __construct() {
    $this->_model = str_replace(' ', '', ucwords(str_replace('_',' ', static::$_table)));
    $this->onConstruct();
  }
  ...
  public function timeStamps(){
    $dt = new \DateTime("now", new \DateTimeZone(timezone_identifiers_list()[35]));
